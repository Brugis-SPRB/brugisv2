...
const {resultsPurge, resetSearch, addMarker, searchTextChanged, selectSearchItem, cancelSelectedItem} = require("../../../MapStore2/web/client/actions/search");
    ...
    render() {
        return (<span>
            <HelpWrapper
                ...
                <UrbisResultList fitToMapSize={this.props.fitResultsToMapSize} searchOptions={this.props.searchOptions} key="nominatimresults"/>
            </span>)
        ;
    }
});
